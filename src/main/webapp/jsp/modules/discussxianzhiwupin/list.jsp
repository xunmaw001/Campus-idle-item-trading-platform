...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">闲置物品评论表管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>闲置物品评论表列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
	...
	<script>
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("discussxianzhiwupin/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"discussxianzhiwupin");
