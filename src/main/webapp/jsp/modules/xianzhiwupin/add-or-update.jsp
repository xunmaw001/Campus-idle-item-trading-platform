...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑闲置物品</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>闲置物品管理</span></li>
				<li class="breadcrumb-item-two"><span>编辑闲置物品</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>起拍价</label>
					<input name="startprice" id="startprice" name="startprice" class="form-control" placeholder="请输入起拍价">
				</div>
				<div class="form-item">
					<label>加价幅度</label>
					<input name="stepprice" id="stepprice" name="stepprice" class="form-control" placeholder="请输入加价幅度">
				</div>
				<div class="form-item">
					<label>一口价</label>
					<input name="endprice" id="endprice" name="endprice" class="form-control" placeholder="请输入一口价">
				</div>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "xianzhiwupin/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("xianzhiwupin/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("xianzhiwupin/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("xianzhiwupin/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dataBind(){
			...
			$("#startprice").val(ruleForm.startprice);	
			$("#stepprice").val(ruleForm.stepprice);	
			$("#endprice").val(ruleForm.endprice);	
		}		
		//图片显示
		function showImg(){
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.startprice != null && res.data.startprice != ''){

						$("#startprice").val(res.data.startprice);
						$("#startprice").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.stepprice != null && res.data.stepprice != ''){

						$("#stepprice").val(res.data.stepprice);
						$("#stepprice").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.endprice != null && res.data.endprice != ''){

						$("#endprice").val(res.data.endprice);
