			...
			<div id="center-container">
				...
				<div :style='{"width":"100%","padding":"0px","margin":"0","background":"none","flex":"1"}' class="right-container">
					<form :style='{"padding":"80px 20px 100px","boxShadow":"0px 0,px 0px #eee","borderColor":"#e6a4b4","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20230207/346e413dce8f4515a5a57219df032ccd.png) no-repeat left top / auto 100%,url(http://codegen.caihongy.cn/20230207/e75d04594fa6401b9993f023e829f7b8.png) no-repeat right bottom / auto 100%","borderWidth":"0px","display":"block","width":"100%","borderStyle":"outset","justifyContent":"space-between","height":"auto"}' class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item"  :style='{"padding":"10px","margin":"0 0 0px 0","borderColor":"#efe4d4","alignItems":"center","background":"none","borderWidth":"0 0 0px","display":"flex","width":"100%","borderStyle":"solid"}'>
							<label :style='{"padding":"0 15px","color":"#333","textAlign":"right","width":"150px","lineHeight":"40px","fontSize":"15px","fontWeight":"500"}' class="layui-form-label">手机</label>
							<input :style='{"padding":"0 10px","margin":"0","borderColor":"#eee","color":"#555","outline":"none","borderRadius":"30px","borderWidth":"1px","background":"#fff","width":"400px","fontSize":"14px","lineHeight":"40px","borderStyle":"solid","height":"40px"}' type="text"  name="shouji" name="shouji" id="shouji" placeholder="手机" autocomplete="off" class="layui-input">
						</div>
						...
						<div class="layui-form-item"  :style='{"padding":"10px","margin":"0 0 0px 0","borderColor":"#efe4d4","alignItems":"center","borderWidth":"0 0 0px","display":"flex","width":"100%","borderStyle":"solid"}'>
							...
							<input :style='{"padding":"0 10px","margin":"0","borderColor":"#eee","color":"#555","outline":"none","borderRadius":"30px","borderWidth":"1px","background":"#fff","width":"360px","fontSize":"14px","lineHeight":"40px","borderStyle":"solid","height":"40px"}' type="number" name="money" id="money" placeholder="余额" autocomplete="off" class="layui-input" disabled="disabled">
							<button :style='{"cursor":"pointer","border":"0","padding":"0px 15px","margin":"0 0 0 10px","borderColor":"#eee","color":"#333","outline":"none","borderRadius":"30px","background":"#f2ecdc","borderWidth":"0px","width":"auto","fontSize":"14px","lineHeight":"36px","borderStyle":"solid","height":"40px"}' id="btn-recharge" type="button" class="layui-btn btn-theme">
