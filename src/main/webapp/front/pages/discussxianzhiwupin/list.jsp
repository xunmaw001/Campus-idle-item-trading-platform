		...
		<script>
			...
			layui.use(['form', 'layer', 'element', 'carousel', 'laypage', 'http', 'jquery','laydate', 'slider'], function() {
				...
				if (jquery('#content').val()) {
					...
					// 获取列表数据
					http.request('discussxianzhiwupin/list', 'get', param, function(res) {
